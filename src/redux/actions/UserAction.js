...
export const Update_profile = (data, userDetails, saveimage,setActiveLoading) => {
...
export const Update = async (data,setPasswordChange, userDetails,navigation,setLoading) => {
